...
// Paleta "aurora" del sitio (mismos tonos que el Hero y el fondo radial de
// Funciones) en vez de los azul cielo/blanco del snippet original.
// u_active_colors es un vec4 (color base + 3 capas como máximo), así que la
// paleta se limita a 4 tonos: pasar más provoca indexado fuera de rango en
// el shader.
const DEFAULT_COLORS = [
  "#1e40af", // --primary
  "#3b82f6", // --aurora-blue-500
  "#a5b4fc", // --aurora-indigo-300
  "#ddd6fe", // --aurora-violet-200
];

// Constantes de módulo: si estos defaults fuesen literales en la firma de la
// función, cada render crearía una referencia nueva y el useEffect de abajo
// (que los lleva en sus dependencias) recrearía el canvas y el contexto WebGL
// en cada render en lugar de una sola vez al montar.
const DEFAULT_NOISE_FREQUENCY: [number, number] = [0.0001, 0.0009];
const DEFAULT_DEFORM = { incline: 0.5, noiseAmp: 250, noiseFlow: 5 };
