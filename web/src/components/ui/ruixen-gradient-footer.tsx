...
export interface RuixenGradientFooterProps {
   ...
   * along the bottom edge before the scroll reveal starts. `0` keeps it hidden
  ...
  valley?: number;
  /** Vertical glow gradient stops, floor (0) → top (1). */
  stops?: Stop[];
  className?: string;
  style?: CSSProperties;
}
...
export function RuixenGradientFooter({
  ...
  return (
    ...
    >
      ...
      {/* glow: fixed to the viewport — a transformed/filtered ancestor
