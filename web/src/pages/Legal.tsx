        ...
        <main className="space-y-12 py-12 text-sm leading-relaxed text-muted-foreground">
          ...
          <section id="cookies" className="scroll-mt-20 space-y-4">
            ...
            <p>
              ...
              la página puede leerla). No se comparte con terceros. Al ser estrictamente necesaria
              para el funcionamiento del servicio, no verás un banner de cookies: no hay nada que
              consentir.
            </p>
          </section>
